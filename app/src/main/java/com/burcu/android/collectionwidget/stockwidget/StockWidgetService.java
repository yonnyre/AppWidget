    ...
    class StockWidgetRemoteViewsFactory implements RemoteViewsFactory {
        ...
        public RemoteViews getViewAt(int position) {
            ...
            if (position < getCount()) {
                remoteView.setTextViewText(R.id.stock_item_text_view_code, stocks.get(position).getMensaje());
                remoteView.setTextViewText(R.id.stock_item_text_view_price,
                        String.valueOf(stocks.get(position).getNivel())
                );
             /*   remoteView.setImageViewResource(R.id.stock_item_image_view_icon,
                ...
                extras.putString(StockWidgetProvider.KEY_EXTRA_ITEM, stocks.get(position).getMensaje());
